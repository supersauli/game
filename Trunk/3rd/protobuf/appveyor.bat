...
C:/Program Files (x86)/Microsoft Visual Studio/2017/Community/MSBuild/15.0/Bin/MSBuild.exe protobuf.sln /p:Platform=%vcplatform% /logger:"C:/Program Files/AppVeyor/BuildAgent/Appveyor.MSBuildLogger.dll" || goto error
cd %configuration%
