...
{
    public class LuaFunc3Bridge : LuaBase, LuaFunc3
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new LuaFunc3Bridge(reference, luaenv);
		}
		
		public LuaFunc3Bridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
