...
{
    public class LuaFuncBridge : LuaBase, LuaFunc
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new LuaFuncBridge(reference, luaenv);
		}
		
		public LuaFuncBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
