...
{
    public class LuaFunc2Bridge : LuaBase, LuaFunc2
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new LuaFunc2Bridge(reference, luaenv);
		}
		
		public LuaFunc2Bridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
